...
const CONFIG_ROWS: ConfigRow[] = [
  ...
  { section: "Connection › on (intra-region wiring)", key: "offset", type: "hard", desc: "groups[].offset — ring this group starts at. Optional: omitted → previous group's outer ring + gap + 1 (first group with no offset → gap)" },
