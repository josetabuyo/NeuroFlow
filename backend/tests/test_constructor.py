...
class TestConstructor:
    ...
    def test_crear_grilla_de_neuronas(self) -> None:
        ...
        brain, regiones = constructor.crear_grilla(
            width=5,
            height=5,
            filas_entrada=[4],
            filas_salida=[0],
        )
        assert len(brain.neuronas) == 25  # 5x5

    def test_crear_regiones_separadas_de_brain(self) -> None:
        """Constructor creates regions separate from the Brain."""
        constructor = Constructor()
        brain, regiones = constructor.crear_grilla(
            width=5,
            height=5,
        ...
        # Brain does not know about regions
        assert not hasattr(brain, "regiones")
    ...
    def test_conectar_neuronas_con_dendritas_y_sinapsis(self) -> None:
        ...
        neurona_centro = brain.get_neurona("x2y1")
    ...
    def test_aplicar_mascara_de_conexion_relativa(self) -> None:
        ...
        neurona = brain.get_neurona("x2y1")
